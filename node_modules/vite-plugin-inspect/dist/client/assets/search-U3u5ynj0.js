import { Q as defineStore, m as usePayloadStore, e as computed } from './index-BtdlCTR5.js';
import { u as useOptionsStore } from './options-CLywagC6.js';
  ...
  const results = computed(() => {
    ...
    if (state.search.exactSearch) {
      return modules.filter(
        (item) => item.id.includes(state.search.text) || item.plugins.some((plugin) => plugin.name.includes(state.search.text))
      );
    } else {
