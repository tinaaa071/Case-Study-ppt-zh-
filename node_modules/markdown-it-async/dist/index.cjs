...
class MarkdownItAsync extends MarkdownIt__default {
  constructor(...args) {
...
exports.MarkdownItAsync = MarkdownItAsync;
exports.createMarkdownItAsync = createMarkdownItAsync;
exports.default = createMarkdownItAsync;
