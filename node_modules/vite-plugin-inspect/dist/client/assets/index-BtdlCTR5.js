const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-B0IKR4Vj.js","./QuerySelector.vue_vue_type_script_setup_true_lang-DCWyB9OY.js","./_plugin-vue_export-helper-DgDhiqFL.js","./ModuleList.vue_vue_type_script_setup_true_lang-DEtQkuSt.js","./options-CLywagC6.js","./search-U3u5ynj0.js","./_...all_-BjS9PFNY.js","./metric-DkyCohU3.js","./hot-B4h60XAk.js","./module-C4lu75ua.js","./module-fd-wtJJC.css","./plugins-DoaEK2Eq.js"])))=>i.map(i=>d[i]);
...
const routes = [
  {
    path: "/",
    name: "/",
    component: () => __vitePreload(() => import('./index-B0IKR4Vj.js'),true?__vite__mapDeps([0,1,2,3,4,5]):undefined,import.meta.url),
    children: [
      {
        path: ":all(.*)",
        name: "//[...all]",
        component: () => __vitePreload(() => import('./_...all_-BjS9PFNY.js'),true?__vite__mapDeps([6,2]):undefined,import.meta.url)
        /* no children */
      },
      {
        path: "metric",
        name: "//metric",
        component: () => __vitePreload(() => import('./metric-DkyCohU3.js'),true?__vite__mapDeps([7,1,2,4,5,8]):undefined,import.meta.url)
        /* no children */
      },
      {
        path: "module",
        name: "//module",
        component: () => __vitePreload(() => import('./module-C4lu75ua.js'),true?__vite__mapDeps([9,1,2,4,3,8,10]):undefined,import.meta.url)
        /* no children */
      },
      {
        path: "plugins",
        name: "//plugins",
        component: () => __vitePreload(() => import('./plugins-DoaEK2Eq.js'),true?__vite__mapDeps([11,1,2]):undefined,import.meta.url)
        /* no children */
      }
    ]
  }
...
function createStaticRpcClient() {
  async function getModuleTransformInfo(query, id) {
    const { hash } = await __vitePreload(async () => { const { hash } = await import('./index-Chdnb_Yf.js');return { hash }},true?[]:undefined,import.meta.url);
...
const rpc = isStaticMode ? createStaticRpcClient() : createRPCClient(
  "vite-plugin-inspect",
  hot,
  {
...
const usePayloadStore = defineStore("payload", () => {
  ...
  async function init() {
    ...
    if (!metadata.value.instances.some((i) => i.vite === query.value.vite && i.environments.includes(query.value.env))) {
      const instance2 = metadata.value.instances.find((i) => i.vite === query.value.vite);
      if (instance2)
        query.value.env = instance2.environments[0] || "client";
      else
...
export { mergeProps as $, shallowRef as A, inject as B, toRefs as C, getCurrentInstance as D, watchEffect as E, Fragment as F, onBeforeUnmount as G, h as H, isRef as I, nextTick as J, KeepAlive as K, withAsyncContext as L, rpc as M, isDark as N, onModuleUpdated as O, isStaticMode as P, defineStore as Q, renderSlot as R, Suspense as S, vShow as T, customRef as U, tryOnScopeDispose as V, toValue as W, pushScopeId as X, popScopeId as Y, withScopeId as Z, withKeys as _, createBaseVNode as a, normalizeProps as a0, guardReactiveProps as a1, createApp as a2, useVirtualList as a3, toRef$1 as a4, createHotContext as a5, useLocalStorage as a6, toggleDark as a7, ref as b, createElementBlock as c, defineComponent as d, computed as e, onMounted as f, unref as g, normalizeClass as h, createVNode as i, createCommentVNode as j, withDirectives as k, vModelCheckbox as l, usePayloadStore as m, normalizeStyle as n, openBlock as o, withCtx as p, createBlock as q, renderList as r, useRoute as s, toDisplayString as t, useRouter as u, vModelText as v, watch as w, resolveComponent as x, createTextVNode as y, resolveDynamicComponent as z };
