import { _ as _sfc_main$4, e as _sfc_main$5, a as __unplugin_components_3, b as _sfc_main$7, d as _sfc_main$9 } from './QuerySelector.vue_vue_type_script_setup_true_lang-DCWyB9OY.js';
import { H as h, o as openBlock, c as createElementBlock, R as renderSlot, n as normalizeStyle, w as watch, d as defineComponent, C as toRefs, b as ref, f as onMounted, E as watchEffect, e as computed, q as createBlock, p as withCtx, k as withDirectives, i as createVNode, g as unref, a as createBaseVNode, t as toDisplayString, T as vShow, J as nextTick, j as createCommentVNode, y as createTextVNode, F as Fragment, r as renderList, s as useRoute, u as useRouter, U as customRef, V as tryOnScopeDispose, W as toValue, m as usePayloadStore, L as withAsyncContext, O as onModuleUpdated, M as rpc, x as resolveComponent, h as normalizeClass, P as isStaticMode } from './index-BtdlCTR5.js';
import { u as useOptionsStore, _ as _sfc_main$a } from './options-CLywagC6.js';
import { k as kt, a as _sfc_main$6, _ as _sfc_main$8 } from './ModuleList.vue_vue_type_script_setup_true_lang-DEtQkuSt.js';
import { g as getHot } from './hot-B4h60XAk.js';
...
var javascript = {exports: {}};/* Injected with object hook! */
...
var css = {exports: {}};/* Injected with object hook! */
...
var markdown = {exports: {}};/* Injected with object hook! */

var xml = {exports: {}};/* Injected with object hook! */
...
var meta = {exports: {}};/* Injected with object hook! */
...
var pug = {exports: {}};/* Injected with object hook! */

var htmlmixed = {exports: {}};/* Injected with object hook! */
...
function requirePug () {
	if (hasRequiredPug) return pug.exports;
	hasRequiredPug = 1;
	(function (module, exports) {
		// CodeMirror, copyright (c) by Marijn Haverbeke and others
		// Distributed under an MIT license: https://codemirror.net/5/LICENSE
		...
		(function(mod) {
		  mod(requireCodemirror(), requireJavascript(), requireCss(), requireHtmlmixed());
		})(function(CodeMirror) {
...
var sass = {exports: {}};/* Injected with object hook! */
...
var vue = {exports: {}};/* Injected with object hook! */

var overlay = {exports: {}};/* Injected with object hook! */
...
var coffeescript = {exports: {}};/* Injected with object hook! */

var hasRequiredCoffeescript;

function requireCoffeescript () {
	if (hasRequiredCoffeescript) return coffeescript.exports;
	...
	return coffeescript.exports;
}
/* Injected with object hook! */

var stylus = {exports: {}};/* Injected with object hook! */

var hasRequiredStylus;

function requireStylus () {
	if (hasRequiredStylus) return stylus.exports;
	hasRequiredStylus = 1;
	(function (module, exports) {
		// CodeMirror, copyright (c) by Marijn Haverbeke and others
		// Distributed under an MIT license: https://codemirror.net/5/LICENSE
	...
	return stylus.exports;
}
/* Injected with object hook! */

var handlebars = {exports: {}};/* Injected with object hook! */

var simple = {exports: {}};/* Injected with object hook! */
...
var multiplex = {exports: {}};/* Injected with object hook! */
...
var placeholder = {exports: {}};/* Injected with object hook! */
...
function useCodeMirror(textarea, input, options = {}) {
...
function syncCmHorizontalScrolling(cm1, cm2) {
  let activeCm = 1;
...
async function calculateDiffWithWorker(left, right) {
  if (!diffWorker) {
    diffWorker = wrap(
      new Worker(new URL(/* @vite-ignore */ ""+new URL('diff.worker-CJcNH0C8.js', import.meta.url).href+"", import.meta.url), {
        type: "module"
      })
    );
  }
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      watchEffect(async () => {
        ...
        if (props.diff && from.value) {
          ...
          Array.from(removedLines).forEach(
            (i) => cm1.addLineClass(i, "background", "diff-removed")
          );
          Array.from(addedLines).forEach(
            (i) => cm2.addLineClass(i, "background", "diff-added")
          );
        }
        cm1.endOperation();
        cm2.endOperation();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(M), {
        ...
        default: withCtx(() => [
          withDirectives(createVNode(unref(g), {
            "min-size": "10",
            size: unref(leftPanelSize),
            class: "h-max min-h-screen",
            border: "main r"
          }, {
            default: withCtx(() => [
              createBaseVNode("textarea", {
                ref_key: "fromEl",
                ref: fromEl,
                textContent: toDisplayString(unref(from))
              }, null, 8, _hoisted_1$3)
            ]),
            _: 1
          }, 8, ["size"]), [
          ...
          createVNode(unref(g), {
            ...
            default: withCtx(() => [
              createBaseVNode("textarea", {
                ref_key: "toEl",
                ref: toEl,
                textContent: toDisplayString(unref(to))
              }, null, 8, _hoisted_2$3)
            ]),
            _: 1
          }, 8, ["size"])
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_FilepathItem = _sfc_main$2;
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        _cache[0] || (_cache[0] = createBaseVNode("div", {
          ...
          createBaseVNode("div", { "i-carbon:warning-square": "" }),
        ...
        createBaseVNode("div", _hoisted_3$1, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.error.stack, (item, idx) => {
            return openBlock(), createElementBlock(Fragment, { key: idx }, [
              createBaseVNode("div", _hoisted_4$1, toDisplayString(item.functionName || `(anonymous)`), 1),
              createBaseVNode("div", _hoisted_5$1, [
                createVNode(_component_FilepathItem, {
                  filepath: normalizeFilename(item.fileName),
                  line: item.lineNumber,
                  column: item.columnNumber
                }, null, 8, ["filepath", "line", "column"])
              ])
            ], 64);
          }), 128))
        ])
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const info = ref(id.value ? ([__temp, __restore] = withAsyncContext(() => rpc.getModuleTransformInfo(payload.query, id.value)), __temp = await __temp, __restore(), __temp) : undefined);
    ...
    const transforms = computed(() => {
      ...
      if (!trs)
        return undefined;
      let load = false;
      return trs.map((tr, index2) => ({
        ...tr,
        noChange: !!tr.result && index2 > 0 && tr.result === trs[index2 - 1]?.result,
    ...
    const sourcemaps = computed(() => {
      let sourcemaps2 = currentTransform.value?.sourcemaps;
      if (!sourcemaps2)
        return undefined;
      if (typeof sourcemaps2 === "string")
        sourcemaps2 = safeJsonParse(sourcemaps2);
      if (!sourcemaps2?.mappings)
        return;
      if (sourcemaps2 && !sourcemaps2.sourcesContent?.filter(Boolean)?.length)
        sourcemaps2.sourcesContent = [from.value];
      if (sourcemaps2 && !sourcemaps2.sources?.filter(Boolean)?.length)
        sourcemaps2.sources = ["index.js"];
      return JSON.stringify(sourcemaps2);
    });
    getHot().then((hot) => {
      if (hot) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_ModuleId = _sfc_main$6;
      const _component_QuerySelector = _sfc_main$7;
      const _component_ModuleList = _sfc_main$8;
      const _component_NavBar = _sfc_main$4;
      const _component_Badge = _sfc_main$5;
      const _component_PluginName = _sfc_main$9;
      const _component_DurationDisplay = _sfc_main$a;
      const _component_ErrorDisplay = _sfc_main$1;
      const _component_DiffEditor = _sfc_main$3;
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_component_NavBar, null, {
          default: withCtx(() => [
              ...
              unref(deps)?.length ? (openBlock(), createBlock(unref(kt), { key: 0 }, {
                popper: withCtx(() => [
                  createBaseVNode("div", _hoisted_3, [
                    createVNode(_component_ModuleList, { modules: unref(deps) }, null, 8, ["modules"])
                  ])
                ]),
                default: withCtx(() => [
                  createBaseVNode("button", _hoisted_1, [
                    _cache[9] || (_cache[9] = createBaseVNode("span", { "i-carbon-downstream": "" }, null, -1)),
                    createBaseVNode("span", _hoisted_2, toDisplayString(unref(deps).length), 1)
                  ])
                ]),
                _: 1
              ...
              unref(importers)?.length ? (openBlock(), createBlock(unref(kt), { key: 1 }, {
                popper: withCtx(() => [
                  createBaseVNode("div", _hoisted_6, [
                    createVNode(_component_ModuleList, { modules: unref(importers) }, null, 8, ["modules"])
                  ])
                ]),
                default: withCtx(() => [
                  createBaseVNode("button", _hoisted_4, [
                    _cache[10] || (_cache[10] = createBaseVNode("span", { "i-carbon-upstream": "" }, null, -1)),
                    createBaseVNode("span", _hoisted_5, toDisplayString(unref(importers).length), 1)
                  ])
                ]),
                _: 1
              })) : createCommentVNode("", true)
            ...
            createBaseVNode("button", {
              ...
              onClick: _cache[0] || (_cache[0] = ($event) => unref(inspectSourcemaps)({ code: unref(to), sourcemaps: unref(sourcemaps) }))
            }, [
        ...
        !unref(info)?.transforms.length ? (openBlock(), createElementBlock("div", _hoisted_10, [
          ...
          }, " Request the module ")) : createCommentVNode("", true)
        ])) : unref(info) && unref(filteredTransforms) ? (openBlock(), createBlock(_component_Container, {
          key: 1,
          flex: "",
          "overflow-hidden": ""
        }, {
          default: withCtx(() => [
            createVNode(unref(M), {
              ...
              default: withCtx(() => [
                createVNode(unref(g), {
                  ...
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_11, [
                      createBaseVNode("span", _hoisted_12, toDisplayString(unref(payload).query.env) + " TRANSFORM STACK", 1),
                      createBaseVNode("button", {
                        class: "icon-btn",
                        ...
                        createBaseVNode("div", {
                          class: normalizeClass(unref(options).view.showBailout ? "opacity-100 i-carbon-view" : "opacity-75 i-carbon-view-off")
                        }, null, 2)
                      ])
                    ]),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(filteredTransforms), (tr) => {
                      return openBlock(), createElementBlock("button", {
                        ...
                        class: normalizeClass(
                          unref(currentIndex) === tr.index ? "bg-active" : tr.noChange || !tr.result ? "op75 saturate-50" : ""
                        ),
                        onClick: ($event) => index.value = tr.index.toString()
                      }, [
                        createBaseVNode("span", {
                          class: normalizeClass(unref(currentIndex) !== tr.index && (tr.noChange || !tr.result) ? "" : "fw-600")
                        }, [
                        ...
                        tr.error ? (openBlock(), createBlock(_component_Badge, {
                          ...
                          default: withCtx(() => [
                            _cache[17] || (_cache[17] = createBaseVNode("span", { "flex-auto": "" }, null, -1)),
                ...
                createVNode(unref(g), { "min-size": "5" }, {
                  default: withCtx(() => [
                    createBaseVNode("div", _hoisted_14, [
                      unref(currentTransform)?.error ? (openBlock(), createBlock(_component_ErrorDisplay, {
                        key: `error-${unref(id)}`,
                        ...
                        to: unref(to),
                        "h-unset": ""
                      }, null, 8, ["one-column", "diff", "from", "to"]))
                    ])
                  ]),
                  _: 1
                })
