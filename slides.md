...
能將使用者需求與商業目標結合，有參與過大型 B2B/B2C 產品開發的經驗。
-->
...
依照課程種類和醫療專業性分類有這幾個類別，他們有不同的上課和報名的模式。
...
我研究了這些產品都沒有類似的功能。<span style="color:red;">***我們專案開發的功能是比較創新的***</span>，但也因為沒有前例的參考，所以我們也在開發過程中反覆測試並迭代設計。
...
<!--
我製作了 Figma Library 檔案，定義了<span style="color:red;">***完整的「設計系統」以及各種「元件」***</span>，這些元件依功能分類，方便查找，我也標註了每個元件的使用情境、狀態與細節，還有一些功能參考的資料。
...
提升了設計人員與開發人員之間的協作，確保設計與開發的一致性，並<span style="color:red;">***提升專案的維護效率***</span>。
...
左側有一個<span style="color:red;">***可折疊的篩選器***</span>，使用者可以根據各種選項對課程進行篩選和排序。
-->
...
提供基本的<span style="color:red;">***智慧客服***</span>支持，以解決人力不足的問題，進一步提升整體服務質量。
-->
