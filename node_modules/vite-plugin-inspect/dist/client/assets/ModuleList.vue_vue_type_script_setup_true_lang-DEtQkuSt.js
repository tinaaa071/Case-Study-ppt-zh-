import { a as _sfc_main$4, u as useOptionsStore, _ as _sfc_main$7 } from './options-CLywagC6.js';
import { d as defineComponent, e as computed, o as openBlock, q as createBlock, g as unref, c as createElementBlock, h as normalizeClass, N as isDark, X as pushScopeId, Y as popScopeId, J as nextTick, Z as withScopeId, x as resolveComponent, a as createBaseVNode, F as Fragment, R as renderSlot, j as createCommentVNode, n as normalizeStyle, _ as withKeys, p as withCtx, i as createVNode, $ as mergeProps, a0 as normalizeProps, a1 as guardReactiveProps, b as ref, a2 as createApp, H as h$2, t as toDisplayString, m as usePayloadStore, k as withDirectives, s as useRoute, a3 as useVirtualList, a4 as toRef, y as createTextVNode, r as renderList } from './index-BtdlCTR5.js';
import { g as getPluginColor, e as _sfc_main$5, d as _sfc_main$6 } from './QuerySelector.vue_vue_type_script_setup_true_lang-DCWyB9OY.js';
...
const q = "__floating-vue__popper", Q = () => defineComponent({
  ...
  computed: {
    ...
    parentPopper() {
      var e;
      return (e = this[q]) == null ? undefined : e.parentPopper;
    },
  ...
  methods: {
    show({ event: e = null, skipDelay: t = false, force: o = false } = {}) {
      var i, s;
      (i = this.parentPopper) != null && i.lockedChild && this.parentPopper.lockedChild !== this || (this.pendingHide = false, (o || !this.disabled) && (((s = this.parentPopper) == null ? undefined : s.lockedChild) === this && (this.parentPopper.lockedChild = null), this.$_scheduleShow(e, t), this.$emit("show"), this.$_showFrameLocked = true, requestAnimationFrame(() => {
    ...
    hide({ event: e = null, skipDelay: t = false } = {}) {
      ...
      if (!this.$_hideInProgress) {
        ...
        ((o = this.parentPopper) == null ? undefined : o.lockedChild) === this && (this.parentPopper.lockedChild = null), this.pendingHide = false, this.$_scheduleHide(e, t), this.$emit("hide"), this.$emit("update:shown", false);
      }
    },
    init() {
      var e;
      this.isDisposed && (this.isDisposed = false, this.isMounted = false, this.$_events = [], this.$_preventShow = false, this.$_referenceNode = ((e = this.referenceNode) == null ? undefined : e.call(this)) ?? this.$el, this.$_targetNodes = this.targetNodes().filter((t) => t.nodeType === t.ELEMENT_NODE), this.$_popperNode = this.popperNode(), this.$_innerNode = this.$_popperNode.querySelector(".v-popper__inner"), this.$_arrowNode = this.$_popperNode.querySelector(".v-popper__arrow-container"), this.$_swapTargetAttrs("title", "data-original-title"), this.$_detachPopperNode(), this.triggers.length && this.$_addEventListeners(), this.shown && this.show());
    },
    dispose() {
